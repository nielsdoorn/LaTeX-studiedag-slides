...
%\usepackage[text=confidential]{draftwatermark}
...
\item Browse door de documentatie en probeer je overleaf document te voorzien met een half transparant watermerk met de tekst ``confidential''.
\end{itemize}
