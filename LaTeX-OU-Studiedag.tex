...
\begin{frame}{Waar staan de slides?}
\centering
\includegraphics[width=0.4\textwidth]{images/linkje.png}
% \href{https://edu.nl/64kry}{https://edu.nl/64kry}
\end{frame}
...
\item 1984: \alert{\LaTeX} door Leslie Lamport
 \begin{itemize}
  ...
  \item \LaTeX-macro's + \TeX (engine)% Meestal wordt met de term LaTeX het hele opmaaksysteem bedoeld waar de LaTeX-macro's strikt genomen slechts een klein onderdeel van zijn. (Source: Wikipedia / LaTeX)
 ...
 \end{itemize}\pause
\item 2012-2017: Overleaf (van Write\LaTeX~en Share\LaTeX)
 \begin{itemize}
  \item Online \LaTeX-editor in een browser
  \item \textbf{Samenwerking}
  \item Real-time WYSIWYG (soort-van)
...
\begin{frame}{Wat doet \LaTeX?}
\LaTeX is een \textit{framework} waarin documenten beginnen met \mintinline{latex}{\documentclass}, uitbreidingen geladen worden met \mintinline{latex}{\packages}, lettertypes op een slimme manier geselecteerd worden (zo dat je bijvoorbeeld \textbf{vetgedrukte} tekst kunt behouden als je het \textit{\textbf{scheefgedrukt}} wilt hebben, pagina's door middel van complexe algoritmes worden gebouwd inclusief ondersteuning voor kopteksten, voetteksten, voetnoten, margenotities, `zwevende' onderdelen et cetera.
\end{frame}
...
\item Er zijn vele packages om uit te breiden
...
\author{Stijn de Gouw \& Niels Doorn}
\begin{document}
\maketitle
...
Maak een document dat er zo uitziet na compileren:

\fbox{\includegraphics[width=0.4\textwidth]{images/gewonedag.jpg}}
\end{frame}
...
\section{Bronnen om mee verder te gaan}
\frame[noframenumbering,plain]{\tableofcontents[currentsection]}
...
\begin{frame}{Opdracht: CTAN gebruiken}

\begin{itemize}
\item Zoek ``draftwatermark'' op CTAN

\item Browse door de documentatie en probeer je overleaf document te voorzien van een half transparant watermerk met de tekst ``confidential''.
\end{itemize}


\end{frame}

\begin{frame}{Einde van de workshop}

Jullie zijn nu allemaal experts op het gebied van \LaTeX!
\vspace{0.4cm}\\
\includegraphics[width=0.6\textwidth]{images/Expert-Linkedin.png}
